export const JOEL_URL = 'https://joel113.github.io';
...
export const ALT_AGREE_LOGO = 'Agree Logo. Click to reset.';
export const ALT_DISBUTE_LOGO = 'Disbute Logo. Click to agree.';
export const ALT_ONGOING_LOGO = 'Ongoing Logo. Click to disbute.';
export const ALT_LOCKED_LOGO = 'Locked Logo. Click to reset.';
